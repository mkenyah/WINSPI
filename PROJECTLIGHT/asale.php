...
// Query the sales table to retrieve the sold items and sum of kshSold
...
// Query to get the total kshSold
$totalQuery = "SELECT SUM(kshSold) AS total_sales FROM sales";
...
<table>
    ...
    <!-- Total Row below Sale Price (Ksh) column -->
    <tfoot>
        <tr class="total-row">
            <td colspan="2"></td>
            <td>Total Sales (Ksh)</td>
            <td colspan="2" style="text-align: right;"><?php echo number_format($totalSales, 2); ?></td>
            <td colspan="3"></td>
        </tr>
    </tfoot>
</table>
