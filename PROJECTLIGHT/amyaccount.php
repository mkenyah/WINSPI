...
if (isset($_SESSION['username'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        // Successful user fetch, alert and show details
        echo "<script>alert('Profile loaded successfully');</script>";
    } else {
...
<div class="account-container">
    <form method="POST" action="aupdate_account.php" onsubmit="showAlert()">
        ...
        <script>
        // Add a custom alert when the form is submitted (optional)
        function showAlert() {
