...
<script>
    ...
    function setProductId() {
        ...
        if (category) {
            ...
            alert("Product ID has been generated: " + productId); // Alert for product ID generation
        } else {
    ...
    function calculateProfit() {
        ...
        if (!isNaN(quantity) && !isNaN(pricePerBottle)) {
            ...
            document.getElementById("expectedProfit").value = ""; // Reset if input is not valid
        }
    }
    ...
    function validateForm() {
        ...
        if (!productId || !productName) {
            ...
            return false; // Prevent form submission if fields are incomplete
        }
        alert("Product added successfully!"); // Alert on successful form submission
